...
const parseNonGenericResponsesFromBotOutput = (genericObj) => {
  ...
  class App extends React.Component {
      ...
      this.state = {
        ...
        paths: [
          ...
          },
          {
            ...
            description: 'Provide the required information to schedule an appointment.',
    ...
    iterateResponese(responses, index) {
      if (index < responses.length) {
        ...
        if (res.type !== 'pause') {
          ...
          if (res.typing) {
            inputField.placeholder = 'Assitant is thikining... hmmm...';
          }
          setTimeout(() => {
    ...
    render() {
      return (
        <div className="BHC App"> //ibm specific
          <SelectionSidebar
